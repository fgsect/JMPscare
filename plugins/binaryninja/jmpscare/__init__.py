...
class TableModel(QAbstractTableModel):
    def __init__(self, data):
        ...
        self._data = data
        self._patched = []
        self.COLUMN_HEADERS = ["Address", "Condition", "Taken", "New Cov"]
...
def import_data(bv):
    file_name = interaction.get_open_filename_input(
        "Choose JMPscare analysis output file."
    )
...
PluginCommand.register(
    "JMPscare\\Import Data",
    "Import analysis data previously generated with the JMPscare anlysis tool",
    import_data,
)
openDockWidget()
